...
| Component | Path | Role |
|-----------|------|------|
| **Veterinary Clinic** | `veterinary_clinic-saas-19.3.1.3/veterinary_clinic/` | Studio `x_pets`, consultations, CRM, website appointments, sales, POS, FSM |
| **Pet Management** | `pet_management-19.0.1.0.0/pet_management/` | Health, boarding, grooming, training, diet, internal appointments |
| **Petget** | `petget_dog_knowledge-19.0.1.0.0/` | AKC breeds, documents, reminders (on clinic pets via bridge) |
| **Petget bridge** | `veterinary_clinic-saas-19.3.1.3/veterinary_petget_bridge/` | Petget on `x_pets`; hides duplicate Petget app |
| **PM bridge** | `veterinary_clinic-saas-19.3.1.3/veterinary_pet_management_bridge/` | 1:1 sync `x_pets` ↔ `pet.pet` |
| **Support** | `veterinary_clinic-saas-19.3.1.3/base_industry_data/`, `pos_stock/`, `planning_field_service_worksheet/` | Industry dependencies |
...
```ini
addons_path = ...,
    D:\odoo\odoo19\projects\edafa__veterinary_demo\veterinary_clinic-saas-19.3.1.3,
    D:\odoo\odoo19\projects\edafa__veterinary_demo\pet_management-19.0.1.0.0,
    D:\odoo\odoo19\projects\edafa__veterinary_demo\petget_dog_knowledge-19.0.1.0.0
```
...
```
edafa__veterinary_demo/
├── README.md                          ← this file
├── docs/
│   ├── USER_GUIDE.md
│   ├── PET_MANAGEMENT_BRIDGE_PLAN.md
│   └── screenshots/                   ← workflow UI captures
├── pet_management-19.0.1.0.0/
├── petget_dog_knowledge-19.0.1.0.0/
├── veterinary_clinic-saas-19.3.1.3/
│   ├── veterinary_clinic/
...
└── tests/playwright/                  ← Playwright screenshot suite
```
